...
function App() {
  return (
    <div className="flex justify-center items-center h-screen sm:px-6 z-10">
      <div className="border-2 rounded-2xl shadow-2xl sm:p4 xl:w-3/12">
        ...
        <div className="px-4 text-center">
          ...
          <div className="w-full mt-6 mb-2 shadow-sm bg-gray-100 text-gray-600 rounded-md px-4 py-2 font-semibold
